...
### Y. Proximity check — GPS error eats most of the 50m budget
- Measured on two real devices (2026-08-09): an iPhone 12 Pro and a Galaxy S20 FE **lying side by side** produced GPS fixes **~19m apart**. The check itself is confirmed working (it correctly rejected at a −1m limit and accepted at 50m), but the noise floor is high.
