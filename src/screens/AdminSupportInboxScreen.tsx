...
// conversations with UseIT," reached via the shield icon on the regular
// Chats tab (admin-only). Not scoped to a dispute or an overdue rental like
// AdminDisputesScreen/AdminOverdueScreen are: "Contact UseIT -> Message
// UseIT" is reachable on any paid/active rental too, and until this screen
// existed a thread opened that way had no admin-side entry point at all
// (found live 2026-08-19 — Nati messaged support and Ori had nowhere to see
// it, no notification either). Split Renter/Lender the same way the user's
// own Chats tab is, just meaning "renters with an open case" vs "lenders
// with an open case" instead of "my own rentals."
